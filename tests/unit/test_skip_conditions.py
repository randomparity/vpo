...
class TestCodecMatchesEvaluation:
    ...
    def test_codec_matches_exact_match(self):
        ...
        assert _codec_matches_any("hevc", ("hevc", "h265")) is True
    ...
    def test_codec_matches_no_match(self):
        ...
        assert _codec_matches_any("h264", ("hevc", "h265")) is False
    ...
    def test_codec_matches_alias(self):
        ...
        assert _codec_matches_any("h265", ("hevc",)) is True
        # hevc should match h265 pattern
        assert _codec_matches_any("hevc", ("h265",)) is True
...
class TestShouldSkipTranscode:
    """Tests for should_skip_transcode function (T013, T017)."""
