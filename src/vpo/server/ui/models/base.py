"""Base navigation and template context models.

This module defines the core navigation and template structures
used for server-side rendering across all pages.
"""
