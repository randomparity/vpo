...
- [X] T015 [P] [US1] Add test for run_command argument validation in tests/unit/cli/test_analyze_language.py
- [X] T016 [P] [US1] Add test for run_command with file not in database in tests/unit/cli/test_analyze_language.py
- [X] T017 [P] [US1] Add test for run_command with --force flag in tests/unit/cli/test_analyze_language.py
...
- [X] T025 [P] [US2] Add test for status_command summary output in tests/unit/cli/test_analyze_language.py
- [X] T026 [P] [US2] Add test for status_command with file path in tests/unit/cli/test_analyze_language.py
- [X] T027 [P] [US2] Add test for status_command --filter option in tests/unit/cli/test_analyze_language.py
...
- [X] T033 [P] [US3] Add test for clear_command requires path or --all in tests/unit/cli/test_analyze_language.py
- [X] T034 [P] [US3] Add test for clear_command --dry-run output in tests/unit/cli/test_analyze_language.py
- [X] T035 [P] [US3] Add test for clear_command confirmation prompt in tests/unit/cli/test_analyze_language.py
